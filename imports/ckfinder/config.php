...
$config['authentication'] = function () {
     //return true;
    session_start();
     return isset($_SESSION['autenticado_painel']) && $_SESSION['autenticado_painel'];
...
$config['roleSessionVar'] = 'CKFinder_UserRolebzautomotiveuser';
